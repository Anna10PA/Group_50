...
import random
student_list = ["ალექსანდრე ეგუტია" , "გიორგი პავლიაშვილი" , "გიორგი წიბლიაშვილი" ,"ზუკა ქორიძე" , "ლევან გენძეხაძე"  , "მათე ფირანიშვილი" , "ნიკა კოტრიკაძე" , 'ალექსანდრე სამუშია', 'იაკობ დოღნაძე']

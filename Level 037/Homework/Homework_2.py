...
import random
student_list = ["ალექსანდრე ეგუტია" , "გიორგი პავლიაშვილი" , "გიორგი წიბლიაშვილი" ,"ზუკა ქორიძე" , "თამარ სვანიძე"
, "ლევან გენძეხაძე" , "ლუკა გოგოხია" , "ლუკა ჭედია" , "მათე ფირანიშვილი" , "ნიკა კოტრიკაძე" , "სიკა სოსელია"]

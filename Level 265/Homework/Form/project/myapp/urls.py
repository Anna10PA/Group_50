...
from .views import main, reg, log, user_page, logout, user_profile, add_post, edit_profile_pic, code, update_email
...
urlpatterns = [
    ...
    path('home/update_email', update_email, name='update_email'),

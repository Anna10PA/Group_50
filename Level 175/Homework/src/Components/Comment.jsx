...
function Comment() {
    ...
    return (
        <section className="py-[50px] flex flex-col items-start gap-[60px] w-full overflow-hidden max-md:gap-[20px]">
            <div className="flex items-end w-full justify-between px-[70px] max-md:px-[20px] gap-[30px] ">
                <h1 className="text-[45px] font-[800] max-md:text-[30px] max-sm:text-[26px] leading-[50px] max-sm:leading-[30px]">
                    OUR HAPPY CUSTOMERS
                </h1>

function Card_01({ img, name, rate, price, oldPrice, onClick }) {
    let array = []
    ...
    return (
        <div className='w-[100%] flex flex-col items-start justify-between gap-[8px] max-h-[400px]' onClick={onClick} >

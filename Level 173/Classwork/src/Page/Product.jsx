import { useLocation, useParams, useContext } from 'react-router-dom'
...
function Product() {
    ...
    let item = useContext(UserContext);
                ...
                <div className='flex items-start justify-between gap-[40px] max-lg:flex-col max-lg:items-center '>
                    <div className='flex items-center gap-[20px] w-[60%] max-sm:flex-col-reverse max-lg:w-[100%]'>
                        <div className='flex flex-col items-center gap-[20px] max-sm:flex-row'>
                            <div className='w-[150px] h-[170px] overflow-hidden flex items-center justify-center rounded-[10px] duration-200 cursor-pointer bg-[#f2f3ee] max-sm:w-[100px] max-sm:h-[100px]'>
                            ...
                            <div className='flex items-center gap-[20px] flex-wrap max-sm:gap-[10px]'>
                                {
                                    product.sizeList.map(item => {
                                        return <button className='bg-[rgba(240,240,240,1)] text-[rgba(0,0,0,0.6)] cursor-pointer px-[25px] py-[10px] text-[16px] rounded-[20px]  max-sm:text-[14px]'>{item}</button>
                                    })
                                }
                            </div>
                        </div>

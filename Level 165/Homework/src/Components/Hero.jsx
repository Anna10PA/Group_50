function Hero() {
  return (
    <>
      <section className='bg-[rgba(242,240,241,1)] min-h-[70vh] flex flex-col justify-center overflow-hidden relative'>
        <div className="w-full flex items-center justify-between px-[80px] max-lg:px-[0px] relative max-xl:pt-[80px] max-sm:pt-[40px] max-lg:flex-col max-xl:px-[40px]">
          <div className='flex flex-col items-start gap-[30px] max-lg:px-[20px]'>
            <h1 className='font-[900] text-[75px] leading-[75px] max-md:text-[40px] max-md:leading-[40px] max-2xl:text-[50px] max-xl:text-[50px]'>FIND CLOTHES <br />THAT MATCHES <br /> YOUR STYLE</h1>

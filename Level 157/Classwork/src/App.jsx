  ...
  return (
    <div className='bg-[#141c2f] w-full h-screen flex items-center justify-center'>
      ...
      <div className="min-w-[300px] max-w-[650px] w-[50%] flex flex-col gap-[30px]">
        ...
        {/* search */}
        <form className='bg-[#1f2a48] font-Inconsolata flex items-center gap-[20px] justify-between rounded-[10px] px-[10px] py-[10px] pl-[30px]' onSubmit={(e)=> {
          submitFunc(e)
        }}>
     ...
     {isFind ? <MainCard user={user}/> : <h1 className='text-white text-[60px] text-center font-[600] tracking-[2px]'>Not Found 404</h1>}
    </div>
    </div >
  )
}
